...
export default class App extends Component {
  ...
  generateRandomNumber = () => {
    ...
    this.setState({ randomNumber: randomNumber, isScracted: true });
    return randomNumber;

    // // TODO: genrate random number
  };

  scratchItem = itemNumber => {
    // TODO: decide lucky or unlucky
    if (this.state.numberOfScraches > 0) {
      this.setState((prevState, props) => {
        return { numberOfScraches: prevState.numberOfScraches - 1 };
      });
  ...
  resetGame = () => {
    ...
    this.setState(
      { ...INITIAL_STATE, randomNumber: this.generateRandomNumber() },
      () => {
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        <View style={styles.numberOfScraches}>
          <Text style={styles.topText}>
            Number of scratchs left: {this.state.numberOfScraches}
          </Text>
        </View>
